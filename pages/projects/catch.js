...
const Catch = () => {
  ...
  const { module: refCardSort, controls: cardSortControls } = useModuleInView();
  const { module: refLogin, controls: loginControls } = useModuleInView();
  const { module: refLoginShowcase, controls: loginShowcaseControls } = useModuleInView();
  const { module: refConnect, controls: connectControls } = useModuleInView();
  const { module: refConnectShowcase, controls: connectShowcaseControls } = useModuleInView();
  const { module: refShop, controls: shopControls } = useModuleInView();
  const { module: refShopShocase, controls: shopShowcaseControls } = useModuleInView();
  ...
  return (
    <AnimateOpacity>
      ...
      <motion.div
        ref={refLoginShowcase}
        initial="initial"
        animate={loginShowcaseControls}
        variants={moduleVariants}
      >
        <Showcase
          containerHeight="h-[174.16px]"
      ...
      <motion.div
        ref={refConnectShowcase}
        initial="initial"
        animate={connectShowcaseControls}
        variants={moduleVariants}
      >
        <Showcase
          containerHeight="h-[174.16px]"
