...
const Ongo = () => {
  ...
  const { module: refEmpathy, controls: empathyControls } = useModuleInView();
  const { module: refSketches, controls: sketchesControls } = useModuleInView();
  const { module: refFold, controls: foldControls } = useModuleInView();
  const { module: refFoldShowcase, controls: foldShowcaseControls } = useModuleInView();
  const { module: refHow, controls: howControls } = useModuleInView();
  const { module: refHowShowcase, controls: howShowcaseControls } = useModuleInView();
  const { module: refExperts, controls: expertsControls } = useModuleInView();
  const { module: refExpertsShowcase, controls: expertsShowcaseControls } = useModuleInView();
  const { module: refDiagram, controls: diagramControls } = useModuleInView();
  ...
  return (
    <AnimateOpacity>
      ...
      <motion.div
        ref={refExpertsShowcase}
        initial="initial"
        animate={expertsShowcaseControls}
        variants={moduleVariants}
      >
        <Showcase
          containerHeight="h-[206.92px]"
